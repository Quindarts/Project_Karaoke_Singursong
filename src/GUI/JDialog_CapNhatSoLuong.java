...
public class JDialog_CapNhatSoLuong extends JFrame implements ActionListener {
	 ...
	 * Create the frame.
	 */
	public JDialog_CapNhatSoLuong(JTable table_datDichVu, int soLuong, int colSelected, int rowSelected) {
...
//			dv = DAO_DV.layDichVu_TheoTenDichVu(tenDV);
		...
		if (o.equals(btn_saveTT)) {
			...
			if (Integer.parseInt(soLuong) == 0) {
				...
				if (Integer.parseInt(txt_soLuong.getText()) <= getSoLuongBanDau()) {
					...
					table_DichVu.setValueAt(String.valueOf(getSoLuongBanDau() - soLuongMoiCapNhat), rowSelected,
							colSelected);
