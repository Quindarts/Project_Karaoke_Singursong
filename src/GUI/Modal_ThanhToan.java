...
//		txt__thoiGianTraPhong.setText(hDate.chuyenDateThanhString(hoaDon.getThoiGianKetThuc()));
	...
	public void actionPerformed(ActionEvent e) {
		...
		if (o.equals(btn__thanhToan)) {
			...
			HD = new HoaDon(CTDV.getHoaDon().getMaHoaDon(), KH, NV,PD, KM, HD.getNgayLap(), "Đã thanh toán", HD.getNgayLap());
		...
		if(o.equals(txt__tienKhachDua)) {
			...
			if(comparison < 0) {
	            ...
	            txt__tienThoiLai.setText(finalTongTien.toString());
			}
		}
	}
	...
	public void renderTableDichVu(String maP) {
		...
		if(chiTietHD != null) {
			...
			Object[] rowData = {dv.getMaDichVu(), dv.getTenDichVu(), dv.getSoLuong(), dv.getDonGia(), dv.getSoLuong() * dv.getDonGia(), "cap nhat"};
	...
	public void mouseClicked(MouseEvent e) {
		...
		txt__tienhoadonPhong.setText(df.format(loaiPhong.getGiaTien() * hourDiff + (minDiff * loaiPhong.getGiaTien() / 60) + sum));
