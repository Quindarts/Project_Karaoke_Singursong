...
//		panel_Table.setBackground(Color.WHITE);
		pnl_HoaDon.setBounds(0, 37, 1296, 635);
		panel.add(pnl_HoaDon);
		...
		table_HoaDon.setModel(new DefaultTableModel(
			...
			new String[] {
				"M\u00E3 h\u00F3a \u0111\u01A1n", "Ng\u00E0y l\u1EADp", "Kh\u00E1ch h\u00E0ng", "Nh\u00E2n vi\u00EAn", "T\u1ED5ng ti\u1EC1n"
			}
		) {
			/**
			 * 
...
//               System.out.println(maKhachHang + "," + hoTen + "," + gioiTinh + "," + ngaySinh + "," + diaChi + "," + sdt + "," + diemThuong + "," + ghiChu );
		...
		pnl_Loc_TheoThoiGian.setBorder(new TitledBorder(new EtchedBorder(EtchedBorder.LOWERED, new Color(255, 255, 255), new Color(160, 160, 160)), "Theo kho\u1EA3ng th\u1EDDi gian", TitledBorder.LEFT, TitledBorder.TOP, null, new Color(0, 0, 0)));
		...
		pnl_Loc_TheoTongTien.setBorder(new TitledBorder(null, "Theo t\u1ED5ng h\u00F3a \u0111\u01A1n", TitledBorder.LEADING, TitledBorder.TOP, null, null));
		...
		panel_TongTien.setBackground(new Color(255, 255, 255));
		...
		panel_TongTien.add(pnl_PhanTrang);
		...
		txt_TongDoanhThu.setBounds(136, 4, 199, 18);
		...
		txt_TongSoHoaDon.setBounds(136, 4, 36, 18);
		...
		pnl_DichVu.setBounds(0, 0, 1296, 672);
		panel.add(pnl_DichVu);
		
		JScrollPane scrollPane_DichVu = new JScrollPane();
		scrollPane_DichVu.setBounds(10, 47, 1019, 549);
		...
		table_DichVu.setModel(new DefaultTableModel(
			...
			new String[] {
				"T\u00EAn d\u1ECBch v\u1EE5", "S\u1ED1 l\u01B0\u1EE3ng nh\u1EADp", "S\u1ED1 l\u01B0\u1EE3ng b\u00E1n", "S\u1ED1 l\u01B0\u1EE3ng t\u1ED3n", "T\u1ED5ng ti\u1EC1n b\u00E1n"
			}
		) {
			/**
			 * 
		...
		panel_Loc_DichVu.setBounds(1031, 47, 255, 615);
		...
		pnl_Loc_TheoThoiGian_1.setBorder(new TitledBorder(new EtchedBorder(EtchedBorder.LOWERED, new Color(255, 255, 255), new Color(160, 160, 160)), "Theo kho\u1EA3ng th\u1EDDi gian", TitledBorder.LEFT, TitledBorder.TOP, null, new Color(0, 0, 0)));
		...
		pnl_Loc_TheoTongTien_1.setBorder(new TitledBorder(new EtchedBorder(EtchedBorder.LOWERED, new Color(255, 255, 255), new Color(160, 160, 160)), "Theo t\u1ED5ng gi\u00E1 ti\u1EC1n b\u00E1n", TitledBorder.LEADING, TitledBorder.TOP, null, new Color(0, 0, 0)));
		...
		panel_TongTien_DichVu.setBounds(10, 598, 1019, 64);
		...
		txt_TongTien_DichVu.setBounds(136, 4, 199, 18);
		...
		txt_TongSo_DichVu.setBounds(136, 4, 36, 18);
