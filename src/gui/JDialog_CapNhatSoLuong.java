...
public class JDialog_CapNhatSoLuong extends JFrame implements ActionListener {
	...
	public JDialog_CapNhatSoLuong(JTable table_datDichVu, JTable table_DichVu, int soLuong, int colSelected,
			int rowSelected) {
...
//		btn_giam.setOpaque(false);
		btn_giam.setIcon(new ImageIcon(JDialog_CapNhatSoLuong.class.getResource("/icon/minus_black.png")));
		btn_giam.setSelectedIcon(new ImageIcon(JDialog_CapNhatSoLuong.class.getResource("/icon/minus_black.png")));
...
//		btn_tang.setOpaque(false);
		btn_tang.setIcon(new ImageIcon(JDialog_CapNhatSoLuong.class.getResource("/icon/add_black.png")));
	...
	public void actionPerformed(ActionEvent e) {
		...
		try {
			...
			String maDV = table_datDichVu.getValueAt(rowSelected, 0).toString().trim();
			DichVu dv = DAO_DV.layDichVu_TheoMaDichVu(maDV);
			setDonGiaDV(dv.getDonGia());
			setSoLuongBanDau(dv.getThongTinDichVu().tinhSoLuongConLai());

			System.out.println("Dich vu o modal cap nhat: " + getSoLuongBanDau());
		...
		if (o.equals(btn_save)) {
			...
			DichVu dichVuCapNhat = DAO_DV.layDichVu_TheoMaDichVu(maDichVu);
			ThongTinDichVu ttdvCapNhat = dichVuCapNhat.getThongTinDichVu();
