...
public class JDialog_ThongTinHoaDon extends JDialog {
	...
	public JDialog_ThongTinHoaDon() {
		...
		txtChietKhau.setBounds(356, 631, 168, 22);
		...
		JLabel lblMPhiu_1_1_1_1 = new JLabel("Thuế VAT:");
		...
		txtTienKhachDua.setBounds(101, 631, 193, 22);
...
//		txtTienCoc.setText(Double.toString(cthd.tinhTongTienPhong()));
		...
		if(pdp != null) {
			txtTienCoc.setText(dcf.format(pdp.getTienCoc()));
		}
		else {
			txtTienCoc.setText(dcf.format(0));
		}
