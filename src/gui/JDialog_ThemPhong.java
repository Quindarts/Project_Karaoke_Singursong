...
import other.HelpRamDomMaPhong;
...
public class JDialog_ThemPhong extends JFrame {
	...
	public JDialog_ThemPhong() {
		...
		btn__exit.setIcon(new ImageIcon(JDialog_ThemPhong.class.getResource("/icon/exit_16px.png")));
		...
		btn__Save.setIcon(new ImageIcon(JDialog_ThemPhong.class.getResource("/icon/save_16px.png")));
