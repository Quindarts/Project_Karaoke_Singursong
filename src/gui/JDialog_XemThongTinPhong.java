...
public class JDialog_XemThongTinPhong extends JFrame {
	...
	public void SetModal_XemThongTinPhong(String anhPhong, String tenPhong, String tenLoaiPhong, String viTriPhong,
			String giaPhong, String trangThai, String tinhTrang) {
		...
		lbl_GiaPhong.setText(dcf.format(Double.parseDouble(giaPhong)));
